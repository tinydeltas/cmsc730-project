...
from src.spectrograms import get_spectrogram_live
...
def predict_siamese(i, model, recognizer, recognize_element, loader):     
    compare_set = "val"
...
def start_siamese_prediction(): 
    ...
    while True: 
        try: 
            print("Iteration: ", i)
            predict_siamese(i, model, recognizer, recognize_element, loader)
